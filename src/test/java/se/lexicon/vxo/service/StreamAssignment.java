...
public class StreamAssignment {
    ...
    public void task9() {
        ...
        dtoList = people.stream()
                ...
                .map(person -> {
                    ...
                    PersonDto personDto = new PersonDto(person.getPersonId(), fullName);
                    return personDto;
                })
                .collect(Collectors.toList());
    ...
    public void task10() {
        ...
        optional = people.stream()
                ...
                .map(date -> {
                    String dateString =
                            date.getDayOfWeek().name() + " " + date.getDayOfMonth() + " " + date.getMonth().name() +
                                    " " + date.getYear();
                    return dateString;
                })
                .findFirst();
    ...
    public void task11() {
        ...
        averageAge = (double) totalAge / people.size();
    ...
    public void task14() {
        ...
        //Write code here
        _2020_dates = Stream.iterate(1, day -> day + 1)
                .limit(366)
                .map(day -> LocalDate.ofYearDay(2020, day))
